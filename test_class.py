...
class Candidate:
    def __init__(self, name, stock_price_modifier):
        ...
        self.shares = 10
        self.stock_price_modifer = stock_price_modifier
        self.stock_price = self.set_stock_price()
    ...
    def set_stock_price(self):
        self.stock_price = 1 * self.stock_price_modifer ** (11 - self.get_shares())
...
class Player:
    def __init__(self, name, money):
        ...
        self.delegates = 0
        self.total_votes = 0
    def add_stock(self, candidate):
        candidate.buy_candidate_stock()
